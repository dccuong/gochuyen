      ...
      <nav className="2xl:container 2xl:mx-auto sm:py-6 sm:px-7 py-5 px-4">
        ...
        <div className="flex justify-between ">
          ...
          <div className="hidden sm:flex flex-row items-center space-x-6">
            <ul className="flex">
              <li className="z-[50] group  text-blue-500 hover:text-blue-800 cursor-pointe mx-3">
                <Link to="">
                  <div className="flex">
                ...
                <table
                  className="bg-slate-200 hidden group-hover:block h-[200px] absolute   shadow top-full left-0  px-2 py-1 z-[50]  divide-y w-full rounded-b-md
                "
                >
                  <tr>
        ...
        >
          <div className="flex flex-row items-center justify-center space-x-6 relative">
            <ul className="flex">
              <li className="z-[50] group  text-blue-500 hover:text-blue-800 cursor-pointe mx-3">
                <Link to="">
                  <div className="flex">
                ...
                <table className="bg-white hidden group-hover:block absolute   shadow top-full left-0  px-2 py-1 z-[50]  divide-y w-full">
                  <tr>
                    <td>The Sliding Mr.</td>
                    <td>Malcolm Lockyer</td>
                    <td>1961</td>
                ...
                {/* <ul className="bg-white hidden group-hover:block absolute top-full left-[200%]  px-2 py-1 z-[50] divide-y min-w-[150px]">
                ...
                {/* <ul className="bg-white hidden group-hover:block absolute top-full right-[200%]  px-2 py-1 z-[50]  divide-y min-w-[150px]">
                  <li className="text-[#282828] text-sm py-1.5 font-semibold hover:text-[#4d8a54]">
                    sp
                  </li>
                  <li className="text-[#282828] text-sm py-1.5 font-semibold hover:text-[#4d8a54]">
          ...
          <div className="flex flex-col gap-4 mt-4 w-80 mx-auto ">
            <button className="rounded-md flex space-x-2 w-full h-10 font-normal text-sm leading-3 text-indigo-700 bg-indigo-600 bg-opacity-0 hover:opacity-100 duration-100 border border-indigo-700 focus:outline-none focus:bg-gray-200 hover:bg-gray-200 justify-center items-center">
              Sign Up
            </button>
